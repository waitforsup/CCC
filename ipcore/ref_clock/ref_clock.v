...
module ref_clock (
    ...
    localparam integer STATIC_RATIO0    = 16.0; //@IPC int 1.0000,128.0000 
        
    localparam integer STATIC_RATIO1    = 16; //@IPC int 1,128 
    
    localparam integer STATIC_RATIO2    = 40; //@IPC int 1,128 
    
    localparam integer STATIC_RATIO3    = 40; //@IPC int 1,128 
    
    localparam integer STATIC_RATIO4    = 40; //@IPC int 1,128 
    
    localparam integer STATIC_RATIO5    = 40; //@IPC int 1,128 
    
    localparam integer STATIC_RATIO6    = 1; //@IPC int 1,128 
    
    localparam integer STATIC_RATIOF    = 40.0; //@IPC int 1.0000,128.0000 
        
    localparam integer STATIC_RATIOPHY  = 40; //@IPC int 1,128 
    
    localparam integer STATIC_DUTY0     = 16; //@IPC int 2,255
    
    localparam integer STATIC_DUTY1     = 16; //@IPC int 2,255
    
    localparam integer STATIC_DUTY2     = 40; //@IPC int 2,255
    
    localparam integer STATIC_DUTY3     = 40; //@IPC int 2,255
    
    localparam integer STATIC_DUTY4     = 40; //@IPC int 2,255
    
    localparam integer STATIC_DUTY5     = 40; //@IPC int 2,255
    
    localparam integer STATIC_DUTY6     = 2; //@IPC int 2,255
    
    localparam integer STATIC_DUTYF     = 40; //@IPC int 2,255
    
    localparam integer STATIC_DUTYPHY   = 40; //@IPC int 2,255
    
    localparam integer STATIC_PHASE     = 0; //@IPC int 0,63 
    
    localparam integer STATIC_PHASE0    = 0; //@IPC int 0,7 
    
    localparam integer STATIC_PHASE1    = 3; //@IPC int 0,7 
    ...
    localparam integer STATIC_CPHASE0   = 2; //@IPC int 0,127 
    
    localparam integer STATIC_CPHASE1   = 5; //@IPC int 0,127 
