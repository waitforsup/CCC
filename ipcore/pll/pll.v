...
module pll (
    ...
    localparam real    STATIC_RATIO0    = 5.0; //@IPC int 1.0000,128.0000 
    ...
    localparam real    STATIC_RATIOF    = 13.75; //@IPC int 1.0000,128.0000 
        
    localparam integer STATIC_RATIOPHY  = 24; //@IPC int 1,128 
    
    localparam integer STATIC_DUTY0     = 5; //@IPC int 2,255
    ...
    localparam integer STATIC_DUTYF     = 13; //@IPC int 2,255
