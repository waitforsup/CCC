...
module cmos_pll (
    ...
    localparam real    STATIC_RATIO0    = 67.5; //@IPC int 1.0000,128.0000 
        
    localparam integer STATIC_RATIO1    = 27; //@IPC int 1,128 
    
    localparam integer STATIC_RATIO2    = 14; //@IPC int 1,128 
    
    localparam integer STATIC_RATIO3    = 14; //@IPC int 1,128 
    
    localparam integer STATIC_RATIO4    = 14; //@IPC int 1,128 
    
    localparam integer STATIC_RATIO5    = 14; //@IPC int 1,128 
    
    localparam integer STATIC_RATIO6    = 14; //@IPC int 1,128 
    
    localparam real    STATIC_RATIOF    = 12.5; //@IPC int 1.0000,128.0000 
        
    localparam integer STATIC_RATIOPHY  = 1; //@IPC int 1,128 
    
    localparam integer STATIC_DUTY0     = 67; //@IPC int 2,255
    
    localparam integer STATIC_DUTY1     = 27; //@IPC int 2,255
    
    localparam integer STATIC_DUTY2     = 14; //@IPC int 2,255
    
    localparam integer STATIC_DUTY3     = 14; //@IPC int 2,255
    
    localparam integer STATIC_DUTY4     = 14; //@IPC int 2,255
    
    localparam integer STATIC_DUTY5     = 14; //@IPC int 2,255
    
    localparam integer STATIC_DUTY6     = 14; //@IPC int 2,255
